...
for (i = 0; i < starWarsCharacters.length; i++) {
  ...
  switch(personaggi.eye_color){
    case "blue" : 
    eyeColor.blue.push(personaggi)
    break
    case "yellow" :
      eyeColor.yellow.push(personaggi)
      break
    case "brown" :
      eyeColor.brown.push(personaggi)
      break
    case "red" :
      eyeColor.red.push(personaggi)
      break
    case "blueGray" : 
    eyeColor.blueGray.push(personaggi)
    break
  }
}
